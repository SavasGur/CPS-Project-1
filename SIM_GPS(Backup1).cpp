...
const AP_Param::GroupInfo SIM::GPSParms::var_info[] = {
    ...
    // @User: Advanced
    AP_GROUPINFO_FLAGS("ENABLE",    1, GPSParms, enabled, 1, AP_PARAM_FLAG_ENABLE),
...
void GPS::update()
{
    ...
    double spoofed_latitude = -35.36446354;
    double spoofed_longitude = 149.16377792;

    double target_latitude = -35.36449952;
    double target_longitude = 149.16407814;

    if (now_ms >= 60000 && now_ms < 90000) {
        
        d.latitude = spoofed_latitude;
        d.longitude = spoofed_longitude;

    } else if (now_ms >= 90000 && now_ms < 100000) {
        
        d.latitude = target_latitude;
        d.longitude = target_longitude;
        d.speedN = 0.0;
        d.speedE = 0.0;
        d.speedD = 0.0;
        d.have_lock = true;
